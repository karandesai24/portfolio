  ...
  useEffect(() => {
    ...
    revealTl
      ...
      .from(
        ...
        { opacity: 0, duration: 0.4, stagger: 0.5 },
        "<"
      );
    ...
    >
      ...
      <div className="flex flex-col pt-40 md:pt-0 select-none">
        ...
        <h1 className={`${styles.heroName} text-white text-6xl font-semibold`}>
          <span className={`relative ${styles.emphasize} seq`}>Karan</span>
          <span className="seq"> Desai</span>
        </h1>
        <p>
          <span
            ref={typedEl}
      ...
      <div
        className="absolute visible w-5/12 bottom-1.5 lg:visible lg:right-12 2xl:right-16"
        ref={lottieRef}
      ></div>
    </section>
  );
